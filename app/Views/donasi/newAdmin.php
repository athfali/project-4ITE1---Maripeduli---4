    ...
    <div class="container px-4 px-lg-5">
        <div class="row gx-4 gx-lg-5">
            <div class="col-md-10 col-lg-8 mx-auto text-center">
                ...
                <h2 class="text-black mb-5">Silahkan mengisi form admin terlebih dahulu</h2>
                <form action="/donasi/createAdmin" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" id="example-donasi-deskripsi"
                            aria-describedby="emailHelp" placeholder="Masukan Alamat Anda..." required
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="level" aria-describedby="emailHelp"
                            placeholder="level... " required name="level" value="admin" disabled>
                    </div>
