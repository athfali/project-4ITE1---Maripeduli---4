    ...
    <div class="container px-4 px-lg-5">
        <div class="row gx-4 gx-lg-5">
            <div class="col-md-10 col-lg-8 mx-auto text-center">
                <i class="fas fa-user-cog fa-2x mb-2 text-black"></i>
                <h2 class="text-black mb-5">Silahkan edit data Admin</h2>
                <h5 class="text-black form-label d-flex">Update Admin : <?= $data['nama'] ?></h5>

                <form action="/donasi/<?= $data['id'] ?>/updateAdmin" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="example-donasi-deskripsi"
                            aria-describedby="emailHelp" placeholder="Masukan Alamat Anda..." required name="alamat"
                            value="<?= $data['alamat'] ?>" name="deskripsi">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="level" aria-describedby="emailHelp"
                            placeholder="level... " required name="level" value="<?= $data['level'] ?>">
                    </div>
